...
function! abq_amplitudes#Read(firstLine, lastLine)
...
function! abq_amplitudes#Write(startLine, points, strFormat)
...
function! abq_amplitudes#WhatNumFormat(str, width)
...
function! abq_amplitudes#Shift(line1,line2,...)
...
function! abq_amplitudes#Scale(line1,line2,...)
...
function! abq_amplitudes#Resample(line1,line2,...)
  ...
  " save data
  call abq_amplitudes#Write(a:line1, tempPoints, strFormat)

endfunction

"-------------------------------------------------------------------------------

function! abq_amplitudes#AddPoint(line1,line2,...)
...
function! abq_amplitudes#Swap(line1,line2)
